  ...
  export default function CardShuffler() {
    ...
    return (
        <div className='card-shuffler h-auto flex flex-col justify-center gap-2 my-4'>
            ...
            <button className='bg-gray-600 inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-gray-500 hover:bg-white'onClick={() => runShuffler(randomizePosition(people))}>Shuffle</button>
        </div>
    )
  }